...
async def main():
    ...
    try:
        ...
        world = World(client, scene_config_name="scene_basic_drone.jsonc", sim_config_path=SIM_CONFIG, delay_after_load_sec=2)
        ...
        drone.arm()
        # Raise to ~2 m AGL in NED (down is +). Negative z goes up.
        # await (await drone.move_by_velocity_async(v_north=0, v_east=0, v_down=-1.0, duration=2.0))
        # or, if available in your client:
        # await (await drone.move_to_position_async(0.0, 0.0, -2.0, velocity=1.0))
